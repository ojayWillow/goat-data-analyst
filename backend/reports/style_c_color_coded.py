# Style C: Color-Coded Backgrounds
# Subtle pastel section backgrounds with white elevated cards
...
class UltimateReportGenerator:
    def __init__(self):
        print("✅ Style C: Color-Coded Backgrounds")
    ...
    def generate(self, result: AnalysisResult) -> str:
        ...
        <head>
            ...
            <title>GOAT Data Analysis Report - Style C</title>
            {self._get_styles()}
        </head>
        <body>
    ...
    def _build_header(self, result: AnalysisResult) -> str:
        ...
        <header class="report-header">
            <div class="logo">
                ...
                <p class="tagline">Style C: Color-Coded Sections</p>
            </div>
    ...
    def _build_summary(self, result: AnalysisResult) -> str:
        ...
        return f"""
        <section class="color-section bg-purple">
            <h2 class="section-title">Executive Summary</h2>
            <div class="summary-grid">
                <div class="summary-card white-card">
    ...
    def _build_quality_dashboard(self, result: AnalysisResult) -> str:
        ...
        return f"""
        <section class="color-section bg-green">
    ...
    def _build_profile_section(self, result: AnalysisResult) -> str:
        ...
        for col in columns[:10]:
            ...
            """
        return f"""
        <section class="color-section bg-blue">
            <h2 class="section-title">Data Profile</h2>
            <div class="profile-table-container white-card">
    ...
    def _build_charts_section(self, result: AnalysisResult) -> str:
        if not result.charts or len(result.charts) == 0:
            return ""
        return f"""
        <section class="color-section bg-orange">
            <h2 class="section-title">Visualizations</h2>
            <div class="charts-grid white-card">
    ...
    def _build_footer(self, result: AnalysisResult) -> str:
        ...
        <footer class="report-footer">
            ...
            <p class="footer-note">Style C: Color-Coded Backgrounds</p>
        </footer>
        """

    def _placeholder_narrative(self) -> str:
        return """<div class="goat-narrative color-section bg-cyan"><p><em>Narrative generation in progress...</em></p></div>"""
    ...
    def _get_styles(self) -> str:
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            /* COLOR-CODED SECTIONS - KEY FEATURE */
            .color-section {
                margin: 50px 40px;
                padding: 40px;
                border-radius: 16px;
            ...
            /* ========================================
               NARRATIVE SECTIONS - PASTEL THEME
               ======================================== */
            ...
            @media (max-width: 768px) {
                ...
                .color-section { margin: 30px 20px; }
