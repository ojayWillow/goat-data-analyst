...
4\. Run bootstrap: `python session\_bootstrap.py`

5\. Read output: What to do today?
...
python session\_bootstrap.py (read what to do)
...
python session\_bootstrap.py --end (end checklist)
